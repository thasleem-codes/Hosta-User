...
interface HeaderProps {
  title: string;
  onBackClick: () => void;
  navbarHeight?: number; // dynamic top offset
}

export function Header({ title, onBackClick, navbarHeight = 0 }: HeaderProps) {
  return (
    <div
      className="sticky z-30 px-4 py-3 bg-green-50 mb-6"
